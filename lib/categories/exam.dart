...
class Exam_cat extends StatefulWidget {
  const Exam_cat({Key? key}) : super(key: key);

  @override
  State<Exam_cat> createState() => _Exam_catState();
}

class _Exam_catState extends State<Exam_cat> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection("posts").where("category",isEqualTo: "Exam").snapshots(),
