...
class Sports_cat extends StatefulWidget {
  const Sports_cat({Key? key}) : super(key: key);

  @override
  State<Sports_cat> createState() => _Sports_catState();
}

class _Sports_catState extends State<Sports_cat> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection("posts").where("category",isEqualTo: "Sports").snapshots(),
